...
document.querySelector("input[name='login']").getAttribute('data-validations').replace(/[^a-z,]/g ,"").split(',')
...
function alertError(element, mensagem){
    ...
    div.innerHTML = errorElement(mensagem);
...
function validar(scope){
    ...
    document.querySelectorAll(scope + " input, select").forEach(function(ipt){
        ...
        if(ipt.hasAttribute('data-validations')){
            var validar = ipt.getAttribute('data-validations').replace(/[^ a-z , A-Z 0-9 -]/g ,"").split(',');
            for(var index = 0; index < validar.length; index++){
                var validationType = validar[index].split("-")[0].replace(" ", "");
                var validationNumber=undefined;
                validar[index].split("-")[1] == undefined ?  validationNumber= undefined : validationNumber = validar[index].split("-")[1].replace(" ", );
...
function validationInit(){
    ...
    var cepMasks = document.querySelectorAll(".cepMask");
